...
//        => optionsBuilder.UseSqlServer("Data Source=.;TrustServerCertificate=True;Initial Catalog=WestWind;Integrated Security=True;Encrypt=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BuildVer__3214EC071C09E9AB");
        ...
        {
            entity.HasKey(e => e.ManifestItemId).HasName("PK__Manifest__9000192C77D89F05");
        ...
        {
            entity.HasKey(e => e.ShipmentId).HasName("PK__Shipment__5CAD378DEEC9282A");
